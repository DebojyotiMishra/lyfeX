//! Bakes the Homebrew library directory into test binaries as an rpath so the Vulkan
...
//! often is), so the variable frequently never reaches spawned test binaries. An rpath is
